...
let
  ...
  outputHashes = {
    ...
    "git+https://github.com/hoprnet/edge-client.git?rev=d556d4aa5db3d6fdb7b6c5a33813a6d8ccc7d9af#d556d4aa5db3d6fdb7b6c5a33813a6d8ccc7d9af" =
      "sha256-tpEsqZwJcx9JLGVQToU3w4h652c3rzpsPOKBYs1d5xw=";
