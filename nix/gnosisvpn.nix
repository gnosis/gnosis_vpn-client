...
let
  ...
  outputHashes = {
    ...
    "git+https://github.com/hoprnet/edge-client.git?rev=c517fccab7ee46c65f1f37dd85ee29407cb3daca#c517fccab7ee46c65f1f37dd85ee29407cb3daca" =
      "sha256-26bwFsrmpe4y9PjS1rTB74PvMgBNUXRa5nNWdwiZO3U=";
