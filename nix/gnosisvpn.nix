...
let
  ...
  outputHashes = {
    ...
    "git+https://github.com/hoprnet/edge-client.git?rev=ddd92624790812acc0b5aa4145f1c6e42c729c3a#ddd92624790812acc0b5aa4145f1c6e42c729c3a" =
      "sha256-9GvKnYRKdk+PSXw9PaVvunrCkJ7mh44l4IgL/R1Q8uE=";
