...
let
  ...
  outputHashes = {
    ...
    "git+https://github.com/hoprnet/edge-client.git?rev=5d7246a3a100666edb5fb71aac31f0d965e4b535#5d7246a3a100666edb5fb71aac31f0d965e4b535" =
      "sha256-h2qDfZ/Xg8Wj6o7iQWgTN0VFd3CXrjpeBZeHtdhQcyA=";
